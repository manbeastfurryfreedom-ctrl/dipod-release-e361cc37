#!/usr/bin/env python3
"""
Modified FPO-RSL-RL play script with Viser visualization support.
...
parser = argparse.ArgumentParser(description="Play with a trained FPO-RSL-RL agent.")
...
parser.add_argument("--testing_phases", type=float, nargs="+", default=None, help="Testing phases for motion tracking (e.g., --testing_phases 0.141 0.013). If provided, environment will randomly sample from these phases.")
