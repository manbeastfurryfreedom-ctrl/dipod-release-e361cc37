  ...
  for gen_length in "${GEN_LENGTHS[@]}"; do
    for ckpt in "${CKPTS[@]}"; do
      ...
      CUDA_VISIBLE_DEVICES=$GPU_LIST torchrun \
        ...
        --output_dir "eval_results/eval_results_gsm8k_base_spg_mix_beta1.5_weight0.5_512_full_$ckpt" \
        --model_path "GSAI-ML/LLaDA-8B-Instruct" \
        --checkpoint_path "${SAVE_DIR}/spg/gsm8k_base_spg_mix_beta1.5_weight0.5_512_full/$ckpt"
    done
  done
done
