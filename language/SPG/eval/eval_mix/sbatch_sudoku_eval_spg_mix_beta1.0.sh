  ...
  for gen_length in "${GEN_LENGTHS[@]}"; do
    for ckpt in "${CKPTS[@]}"; do
      ...
      CUDA_VISIBLE_DEVICES=$GPU_LIST torchrun \
        ...
        --few_shot 0 \
        --output_dir "eval_results/eval_results_sudoku_new_0shot_base_spg_mix_beta1.0_weight0.5_512_$ckpt" \
        --model_path "GSAI-ML/LLaDA-8B-Instruct" \
        --checkpoint_path "${SAVE_DIR}/spg/sudoku_new_0shot_base_spg_mix_beta1.0_weight0.5_512/$ckpt"
    done
  done
done
