...
class DiffuGRPOConfig(TrainingArguments):
    ...
    dipod_beta: float = field(
        default=0.05,
        metadata={"help": "ELBO regularization coefficient for DiPOD."},
    )
    ...
    fpo: bool = field(
        default=False,
        metadata={"help": "Whether to use FPO (Flow Policy Optimization) in DiffuGRPOTrainer."},
    )
